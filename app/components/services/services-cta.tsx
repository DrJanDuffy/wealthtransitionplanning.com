  ...
  return (
    <section className="mb-16 p-12 bg-gradient-to-br from-blue-50 via-blue-100 to-blue-50 rounded-2xl text-center border border-blue-200">
      <div className="max-w-3xl mx-auto">
        ...
        <p className="text-xl md:text-2xl mb-8 max-w-2xl mx-auto leading-relaxed font-medium" style={{ color: '#1f2937' }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Link
            href="/cfp-partners"
            className="inline-flex items-center justify-center px-8 py-4 border-2 border-blue-600 text-blue-700 rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300 font-semibold text-lg"
          >
