      ...
      <div className="grid md:grid-cols-2 gap-8">
        <div className="p-8 bg-gradient-to-br from-neutral-50 to-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Market Knowledge</h3>
          </div>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-3 text-gray-900">Market Expertise Includes:</h4>
        ...
        <div className="p-8 bg-gradient-to-br from-neutral-50 to-white rounded-xl border border-gray-200 hover:shadow-lg transition-all duration-300">
          <div className="flex items-center mb-4">
            ...
            <h3 className="text-2xl font-bold text-gray-900">Service Area Coverage</h3>
          </div>
          <p className="mb-6 text-gray-700 leading-relaxed">
          ...
          <div>
            <h4 className="text-lg font-semibold mb-3 text-gray-900">Primary Service Areas:</h4>
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
