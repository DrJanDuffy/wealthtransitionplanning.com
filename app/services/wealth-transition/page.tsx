        ...
        <section className="mb-16">
          ...
          <div className="space-y-8">
            <div className="p-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              <h3 className="text-3xl font-semibold mb-4">Real Estate Portfolio Analysis</h3>
              ...
              <h4 className="text-xl font-semibold mb-3">Portfolio Analysis Includes:</h4>
            ...
            <div className="p-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              <h3 className="text-3xl font-semibold mb-4">Estate Planning Integration</h3>
              <p className="text-lg mb-4">
              ...
              <h4 className="text-xl font-semibold mb-3">Estate Integration Includes:</h4>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div className="p-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              <h3 className="text-3xl font-semibold mb-4">Tax-Efficient Strategies</h3>
              <p className="text-lg mb-4">
              ...
              <h4 className="text-xl font-semibold mb-3">Tax Strategies Include:</h4>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div className="p-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              <h3 className="text-3xl font-semibold mb-4">Multi-Generational Planning</h3>
              <p className="text-lg mb-4">
              ...
              <h4 className="text-xl font-semibold mb-3">Multi-Generational Services Include:</h4>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <div className="p-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl">
              <h3 className="text-3xl font-semibold mb-4">Property Transition Management</h3>
              <p className="text-lg mb-4">
              ...
              <h4 className="text-xl font-semibold mb-3">Transition Services Include:</h4>
              <ul className="list-disc pl-6 space-y-2">
