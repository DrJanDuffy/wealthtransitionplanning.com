      ...
      <article className="prose prose-lg max-w-none">
        ...
        <section className="mb-16">
          <div className="space-y-8">
            <div className="p-8 border-l-4 border-blue-600 bg-blue-50 dark:bg-blue-900/20 rounded-r-xl">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Step 1: Initial Consultation</h2>
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100">What We Discuss:</h3>
            ...
            <div className="p-8 border-l-4 border-blue-600 bg-blue-50 dark:bg-blue-900/20 rounded-r-xl">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Step 2: Partnership Agreement</h2>
              <p className="mb-4 text-gray-800 dark:text-gray-200 leading-relaxed">
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100">Agreement Includes:</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-800 dark:text-gray-200">
            ...
            <div className="p-8 border-l-4 border-blue-600 bg-blue-50 dark:bg-blue-900/20 rounded-r-xl">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Step 3: Resource Access</h2>
              <p className="mb-4 text-gray-800 dark:text-gray-200 leading-relaxed">
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100">Resources Include:</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-800 dark:text-gray-200">
            ...
            <div className="p-8 border-l-4 border-blue-600 bg-blue-50 dark:bg-blue-900/20 rounded-r-xl">
              <h2 className="text-2xl font-bold mb-4 text-gray-900 dark:text-gray-100">Step 4: Ongoing Collaboration</h2>
              <p className="mb-4 text-gray-800 dark:text-gray-200 leading-relaxed">
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900 dark:text-gray-100">Collaboration Includes:</h3>
              <ul className="list-disc pl-6 space-y-2 text-gray-800 dark:text-gray-200">
        ...
        <section className="mb-16 p-12 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-6 text-gray-900 dark:text-gray-100">Ready to Start the Partnership Process?</h2>
