      ...
      <article className="prose prose-lg max-w-none">
        ...
        <section className="mb-16">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Our Approach to Real Estate and Financial Planning</h2>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="p-8 bg-blue-50 rounded-xl border border-blue-200">
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Collaborative Partnership</h3>
              <p className="text-gray-900 leading-relaxed mb-4">
